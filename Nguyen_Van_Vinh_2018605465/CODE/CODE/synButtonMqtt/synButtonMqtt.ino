...
String mqtt_topic_pub = "nguyenVanVinh/iotBtnInfo";
String mqtt_topic_sub = "nguyenVanVinh/iotRelayControl";
...
//array of pin
const int inputPinArr[7] = {BTN_01, BTN_02, BTN_03, BTN_04, BTN_05, BTN_06};

const int outputPinArr[7] = {OUT_01, OUT_02, OUT_03, OUT_04, OUT_05};
...
void l298nInit()
{
  ...
  ledcAttachPin(L298N_C, 0);
  ledcAttachPin(L298N_D, 1);
}
